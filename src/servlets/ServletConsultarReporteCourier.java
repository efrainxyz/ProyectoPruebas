...
/**
 * Servlet implementation class ServletConsultarReporteCourier
 */
@WebServlet("/ConsultarReporteCourier")
public class ServletConsultarReporteCourier extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ServletConsultarReporteCourier() {
        super();
		...
		if(user!=null){
			try {
				if(user.getRol().getNomTipo().equals("Administrador")){
					...
					request.getRequestDispatcher("/Administrador/ConsultarReporteCourier.jsp").forward(request, response);
				}else{
