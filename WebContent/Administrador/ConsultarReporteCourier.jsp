            ...
            <div class="row">
                <div class="col-sm-12" style="text-align:center;">
                	<div class="col-sm-12" style="text-align:left;">
                		<br>
                		<label for="datosReporte" class="control-label" style="text-align: left; font-size: 30px; color: darkblue;">REPORTE DEL COURIER</label>
                 	</div>
                	<div class="col-sm-12" style="text-align:center;">
                		<br>
				     ...
				     <br>
 						...
 						<tbody>
		 					...
		 					<tr>
					 			...
					 			<%}%>
					 			<td style="text-align: center; vertical-align:middle;"><%if(prendasSede.get(i+4).getEstado().equals("1")){%>Pendiente<%}else{%>Entregado<%}%></td>
					 		</tr>
				 			<%}%>
			 			</tbody>
  					</table>
