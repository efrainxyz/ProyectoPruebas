...
<body style="background-image: url('images/02.png');background-repeat: no-repeat; background-position: center; background-position: right;">
    <div> 
        ...
        <div class="container-fluid">
            <div class="row">
            <form id="form" name="form" method="post" action="<%=request.getContextPath()%>/ModificarTallas" onSubmit="if(!confirm('¿está seguro de realizar esta acción?')){return false;}">
                <div class="col-sm-12" style="text-align:center;">
				    ...
				    <div class="col-sm-12" style="text-align:left;">
				     ...
				     <div class="col-sm-12 form-group">
						...
						<br>
							...
							<div class="col-sm-6" style="text-align: left;">
								<select class="form-control" size="4" name="talla<%=prendas.get(i).getIdTip()%>" required="required"  <%if(mensaje2!=null){%>disabled="disabled"<%}%>>
				    ...
				    <div  class="col-sm-12 form-group" style="text-align:right;">
                		<br>
                		<button class="btn-large btn btn-primary" <%if(mensaje2!=null){%>disabled="disabled"<%}%> type="submit"><b>Modificar</b></button>
                		<br>
                 	</div>
                 	<%if(mensaje1!=null){%>
