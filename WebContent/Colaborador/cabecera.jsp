    ...
    <div class="container-fluid">
        ...
        <div id="navbar" class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-right">
            	<li><a href="<%=request.getContextPath()%>/RegistrarTallas">Registrar tallas de colaboradores</a></li>
            	<li><a href="<%=request.getContextPath()%>/ModificarTallas">Modificar tallas de colaboradores</a></li>
